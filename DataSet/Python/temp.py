...
Dataset = ds.DataSet()
df_acc = Dataset.getdataframeacc("DataSet/csvFiles/Originals/GX012548_HERO9 Black-ACCL.csv")
df_gyr = Dataset.getdataframegyr("DataSet/csvFiles/Originals/GX012548_HERO9 Black-GYRO.csv")
...
Dataset.addfallingdata(49)
print("Video 1 : Add Falling Data DONE !")
Dataset.createcsv('DataSet/csvFiles/csv/Input_vdo12548.csv')
print("Video : DONE !")
...
Dataset_delta.createdeltacsv('DataSet/csvFiles/csvDelta/Input_vdo12548_delta.csv')
