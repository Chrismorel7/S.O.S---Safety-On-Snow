...
Dataset = ds.DataSet()
df_acc = Dataset.getdataframeacc("DataSet/csvFiles/Originals/GX012638_HERO9 Black-ACCL.csv")
df_gyr = Dataset.getdataframegyr("DataSet/csvFiles/Originals/GX012638_HERO9 Black-GYRO.csv")
...
Dataset.createcsv('DataSet/csvFiles/csv/Input_vdo12638.csv')
print("Video : DONE !")
...
Dataset_delta.createdeltacsv('DataSet/csvFiles/csvDelta/Input_vdo12638_delta.csv')
